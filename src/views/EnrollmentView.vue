    ...
    <section class="section">
        <div class="columns">
            <div class="column">
                ...
                <div class="content">
                    <ul>
                        <li><a href="./static/EZPPS-Pristopna-izjava.pdf" target="_blank" rel="noopener noreferrer">pristopno izjavo</a></li>
                        <li>izjavo o spoštovanju <a href="./static/Eticni-kodeks-EZPPS.pdf" target="_blank" rel="noopener noreferrer">Etičnega kodeksa EZPPS (sovpadajočega s kodeksoma ECPP in SKZP)</a></li>
        ...
        <div class="columns">
            ...
            <div class="column">
                <div class="block">
                    ...
                    <div class="block">
                        Pogoji, našteti na tej strani, so navedeni v <a href="./static/STATUT-EZPPS-sprejet-na-redni-seji-skupscine-dne-23.10.2020.pdf" target="_blank" rel="noopener noreferrer">Statutu društva</a>.
                    </div>
                </div>
            </div>
        </div>
