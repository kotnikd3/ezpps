<template>
    <section class="section">
        <div class="container">
            <h4 class="title is-4">Organi društva</h4>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <h5 class="title is-5">Skupščina</h5>
            <div class="block">
            ...
            <hr>
            <h5 class="title is-5">Strokovni svet</h5>
            <div class="block">
            ...
            <hr>
            <h5 class="title is-5">Častno razsodišče</h5>
            <div class="block">
            ...
            <hr>
            <h5 class="title is-5">Nadzorni svet</h5>
            <div class="block">
        ...
        <div class="container">
            <div class="columns is-vcentered">
                <div class="column is-three-quarters notification">
                    ...
                    <div class="block">
                        Strokovni svet sestavljajo: Urška Battelino, Sandra Ferenc, Ana Kocjančič, Anja Košir, Nuša Kovačevič Tojnko, Matija Pajer, Lan Pečjak, Saga Škerlep, Mateja Švetak, Irena Zagajšek.
                    </div>
                    <div class="block">
                        Častno razsodišče sestavljajo: Parov Anzelc, Brigita Korpar, Gašper Lesar.
                    </div>
                    <div class="block">
                        Nadzorni svet sestavljajo: Lea Prešern McCann, Barbara Šinkar, Iztok Zver.
                    </div>
                </div>
