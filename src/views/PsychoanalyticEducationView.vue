<template>
    <section class="section">
        <h2 class="title is-2">Študij psihoanalitične psihoterapije v Sloveniji</h2>
    </section>
    ...
    <section class="section">
        <div class="columns is-vcentered">
            ...
            <div class="column">
                ...
                <div class="block">
                    Specializacija poteka tako, da študentje v tretjem letniku prve stopnje izberejo enega od možnih psihoterapevtskih pristopov. SFU Ljubljana vsako leto omogoča vpis v vsaj dva izmed naslednjih: psihoanalitična psihoterapija, sistemska psihoterapija, geštalt psihoterapija, analitična psihologija, psihoterapija otrok in mladostnikov. Nekatere druge pristope lahko študenti vpišejo v različnih društvih in na inštitutih, s tem da skupne vsebine fakultetnega študija opravijo v okviru SFU Ljubljana.
                </div>
                <div class="block">
