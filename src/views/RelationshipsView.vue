<template>
    <section class="section">
        <div class="container">
            <h2 class="title is-3">O zvezah društev ECPP, SKZP in EAP</h2>
        </div>
    </section>
        ...
        <div class="container">
            <div class="columns is-vcentered">
                ...
                <div class="column">
                    ...
                    <h4 class="subtitle is-5">Evropska konfederacija za psihoanalitično psihoterapijo</h4>
                    <div class="block">
        ...
        <div class="container">
            <div class="columns is-vcentered">
                ...
                <div class="column">
                    ...
                    <h4 class="subtitle is-5">Slovenska krovna zveza za psihoterapijo</h4>
                    <div class="block">
        ...
        <div class="container">
            <div class="columns is-vcentered">
                ...
                <div class="column">
                    ...
                    <h4 class="subtitle is-5">Evropska zveza za psihoterapijo</h4>
                    <div class="block">
