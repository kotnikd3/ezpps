    ...
    <section class="section">
        <div class="columns is-vcentered">
            ...
            <div class="column">
                ...
                <h4 class="subtitle is-4">Evropska konfederacija za psihoanalitično psihoterapijo</h4>
                <div class="block">
    ...
    <section class="section">
        <div class="columns is-vcentered">
            ...
            <div class="column">
                ...
                <h4 class="subtitle is-4">Slovenska krovna zveza za psihoterapijo</h4>
                <div class="block">
    ...
    <section class="section">
        <div class="columns is-vcentered">
            ...
            <div class="column">
                ...
                <h4 class="subtitle is-4">Evropska zveza za psihoterapijo</h4>
                <div class="block">
