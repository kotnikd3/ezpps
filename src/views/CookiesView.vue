<template>
    <section class="section container">
        <h2 class="title is-2">Politika zasebnosti</h2>
    </section>
    ...
    <section class="section container">
        <h3 class="title is-3">Prijava na e-novice</h3>
        <div class="block">
        ...
        <div class="block">
            Za prijavo na e-novice se zbirajo podatki: e-naslov uporabnika.
        </div>
        <div class="block">
            Po poslanem obrazcu z elektronskim naslovom uporabnik na navedeni naslov prejme potrditveno sporočilo, s katerim je do preklica prijavljen na prejemanje-novic. Kadarkoli lahko pisno ali s klikom na gumb odjava v e-novicah zahteva, da upravljavec osebnih podatkov trajno ali začasno preneha uporabljati njegove osebne podatke. Uporabnik lahko zahteva popravek podatkov ali seznanitev z njimi. Evropsko združenje psihoanalitičnih pristopov se zavezuje, da bo podatke skrbno varovala skladno z zakonodajo, ki ureja varovanje osebnih podatkov. Za pošiljanje e-novic se uporablja aplikacijo MailChimp.
        </div>
    </section>
    ...
    <section class="section container">
        <h3 class="title is-3">Pravice uporabnika</h3>
        <div class="block">
        ...
        <div class="content">
            <ul>
                ...
                <li>pravico do popravka oziroma dopolnitve osebnih podatkov,</li>
                <li>pravico do izbrisa osebnih podatkov,</li>
                <li>pravico do omejitve obdelave osebnih podatkov,</li>
                <li>pravico do vpogleda in izvoza osebnih podatkov in</li>
                <li>pravico do ugovora.</li>
            </ul>
        </div>
        <div class="block">
            Svojo zahtevo lahko uporabnik poda pisno na naslov (upravljavec osebnih podatkov)
        </div>
        <div class="block">
            Evropsko združenje psihoanalitičnih pristopov<br>
            Trg mladinskih delovnih brigad 5<br>
            1000 Ljubljana<br>
            Slovenija
        </div>
        <div class="block">
    ...
    <section class="section container">
        ...
        <div class="content">
            <ul>
                <li>podjetju za obdelavo podatkov in informacijske storitve, ki zagotavljajo nemoteno delovanje spletnih strani starfiniti.com (gostovanje na strežniku, pošiljanje e-novic);</li>
                <li>pooblaščenim ustanovam na podlagi sodne zahteve.</li>
            </ul>
        </div>
    </section>
